import { Point } from "src/app/data-core/model/point";
import { EventDataObject } from "src/app/data-core/model/waste-regulation/event-data-object";
...
export declare function moveView(
  targetDomId: string,
  moveDomId: string,
  offsetX: number,
  offsetY: number
);
export declare function moveView2(
  targetDomId: string,
  moveDomId: string,
  offsetX: number,
  offsetY: number
);
export declare function moveView3(
  targetDomId: string,
  offsetX: number,
  offsetY: number
);

export declare function targetPosition(targetDomId: string): {
  left: number;
  top: number;
};
...
export declare function inputFileRead(
  domId: string,
  loadFileFn: (result: string) => void
);
...
export declare function domSize(domId: string): {
  width: number;
  height: number;
};
...
export declare function createVideo(
  forId: string,
  src: string,
  parentDomId: string
);
