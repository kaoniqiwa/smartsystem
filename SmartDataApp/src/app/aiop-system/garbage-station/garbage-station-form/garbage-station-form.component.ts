...
import { FormField, GarbageStationFormService } from "./business/garbage-station-form";
...
export class GarbageStationFormComponent implements OnInit {
  ...
  @Input() saveFn: (success: boolean, item: GarbageStation, formState: FormStateEnum) => void;
  @Input() cancelFn: () => void;
  ...
  onSubmit() {
    ...
    this.formService.saveFrom(formField, (success: boolean, item: GarbageStation, formState: FormStateEnum) => {
