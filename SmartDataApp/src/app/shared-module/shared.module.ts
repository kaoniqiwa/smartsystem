...
} from "../common/directive/date-time-picker.directive";
...
@NgModule({
  ...
  declarations: [
    DateTimePickerDirective,
    DateTimePickerMirrorDirective,
    HWPaginationDirective,
    TouchSpinDirective,
    EChartBarDirective,
    EChartBarDirectiveV2,
    EChartLineDirective,
    HWSPlayerDirective,
    CardDirective,
    EChartPieOutDirective,
    EChartPieInDirective,
    EChartPieMiddleDirective,
    EChartProgressBarBoxDirective,
    EChartProgressBarDirective,
    ...
    StateScaleCardComponent,
    CardComponent,
    BusinessCardGridComponent,
    HeaderSquareListComponent,
    ImageThemeCardComponent,
    HintCardComponent,
    OrderTableCardComponent,
    LineEChartsCardComponent,
    SwitchComponent,
    TimeToolComponent,
    GalleryTargetComponent,
    ImageDescCardComponent,
    IllegalDropEventHistoryComponent,
    IllegalDropEventAnalyzeComponent,
    TreeDropListComponent,
    IllegalDropEventChartComponent,
    IllegalDropEventCardListComponent,
    UserToolComponent,
    LevelListPanelComponent,
    MixedIntoEventHistoryComponent,
    FullGarbageStationComponent,
    GarbageStationComponent,
    GarbageStationCamerasComponent,
    GalleryRollPageComponent,
    IllegalDropEventSummaryComponent,
    IllegalDropEventAnalyzeV2Component,
    VsClassStatisticComponent,
    TreeDropListV2Component,
    GarbageFullHistoryComponent,
    StatisticGarbageCountComponent,
    SelectOptionComponent,
    GarbageStationSummaryComponent,
    FullGarbageStationSummaryComponent,
    GarbageFullHistorySumChartComponent,
