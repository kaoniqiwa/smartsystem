...
import { IllegalDropStatistic } from '../business/illegal-drop-statistic/illegal-drop-statistic';
...
export class StatisticBusinessInjector {
    ...
    constructor(
        ...
        this.businessInjector = Injector.create([
            { provide: IllegalDropStatistic, useValue: new IllegalDropStatistic(this.statisticalDataBufferService, businessParameter), deps: [] },
    ...
    createBusiness(businessConfig: { business: string, dataTime: number, divisionsId: string }) {
...
export const CardBusinessEnum = {
    "IllegalDropStatistic": IllegalDropStatistic,
